...
repl_tool = Tool(
    name="python_repl",
    description="Python shell. Input valid Python code.",
...
def divide(a: float, b: float) -> float:
    """Divide first number by second. Returns error if b is 0"""
    if b == 0:
...
tools = [wiki_tool, arxiv_tool, duck_tool, repl_tool,
         add, subtract, multiply, divide, youtube_tool, weather_tool]
